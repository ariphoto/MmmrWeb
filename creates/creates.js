...
const attendanceCreate = (model) => {
	model.bulkCreate([
		...
		{attendanceId:"68c19272-9369-4f45-a1b7-a51e7cd6cbee",
			time:new Date(new Date("2018-01-21T22:46:01.108Z").toUTCString().replace(" GMT","") ),
			condition:"good",
			detail:"あ",
			studentId:"12d7589d-2a79-4899-974e-b7c725655bf5",
			teacherId:"3f0713de-8070-43b1-a4fa-aa6edd0bde6b"},

        {attendanceId:"00584c65-2b8b-4ffa-8bc8-b43a09613839",
            time:new Date(new Date("2018-01-22T22:46:01.108Z").toUTCString().replace(" GMT","") ),
            condition:"bad",
            detail:"あ",
            studentId:"12d7589d-2a79-4899-974e-b7c725655bf5",
            teacherId:"3f0713de-8070-43b1-a4fa-aa6edd0bde6b"},

        {attendanceId:"2ca00c5f-f8ec-4101-867f-eff580daae60",
            time:new Date(new Date("2018-01-20T22:46:01.108Z").toUTCString().replace(" GMT","") ),
            condition:"good",
            detail:"あ",
            studentId:"e1e249b0-2485-424d-8418-eaa9a222bcd2",
            teacherId:"3f0713de-8070-43b1-a4fa-aa6edd0bde6b"},

        {attendanceId:"38194f10-35ca-4c39-82d9-6170221b254e",
            time:new Date(new Date("2018-01-20T22:46:01.108Z").toUTCString().replace(" GMT","") ),
            condition:"good",
            detail:"あ",
            studentId:"d5162515-7ed3-48d7-b4de-046f13552ce4",
